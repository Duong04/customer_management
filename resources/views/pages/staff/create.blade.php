@extends('layouts.master-layout', ['title' => 'Admin - Thêm người dùng'])
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quản lý người dùng /</span> Thêm người dùng</h4>
                ...
                <div class="card-body">
                  <form class="row" action="{{ route('staffs.store') }}" method="POST">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input value="{{ old('name') }}" name="name" type="text" class="form-control" id="name" placeholder="Họ và tên" />
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input value="{{ old('email') }}" name="email" type="text" class="form-control" id="email" placeholder="example@gmail.com" />
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input value="{{ old('staff.phone') }}" name="staff[phone]" type="text" class="form-control" id="phone" placeholder="Số điện thoại" />
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <select name="staff[gender]" class="form-control" id="gender">
                        ...
                        <option {{ old('staff.gender') == 'male' ? 'selected' : '' }} value="male">Nam</option>
                        <option {{ old('staff.gender') == 'female' ? 'selected' : '' }} value="female">Nữ</option>
                      </select>
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input value="{{ old('staff.join_date', Carbon::now()->format('Y-m-d') ) }}" name="staff[join_date]" type="date" class="form-control" id="join_date" />
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input value="{{ old('staff.dob') }}" name="staff[dob]" type="date" class="form-control" id="dob" />
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <textarea name="staff[address]" rows="4" type="text" class="form-control" id="address" placeholder="Địa chỉ">{{ old('staff.address') }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <textarea name="staff[note]" rows="4" class="form-control" id="note" placeholder="Ghi chú">{{ old('staff.note') }}</textarea>
