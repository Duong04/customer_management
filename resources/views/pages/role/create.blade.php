                ...
                <div class="card-body">
                  <form class="row" action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input value="{{ old('name') }}" name="name" type="text" class="form-control" id="name" placeholder="Customer" />
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input value="{{ old('description') }}" name="description" type="text" class="form-control" id="description" placeholder="Mô tả" />
                              ...
                              <div class="form-group form-check-{{$item->id}}">
                                  <div class="row gutters-xs">
                                      ...
                                      @foreach ($actions as $action)
                                          ...
                                          <div class="col-auto ms-3 d-flex align-items-center mt-3">
                                              <label class="colorinput me-2">
                                                  <input id="checkbox-{{$action->id}}-{{$item->id}}" name="actions[{{$item->id}}][]" type="checkbox" value="{{$action->id}}" class="colorinput-input form-check-input check-action" />
                                                  <span class="colorinput-color bg-info"></span>
                                              </label>
